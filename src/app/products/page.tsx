...
const products = [
  {
    id: 1,
    name: "AA",
    description: "Premium, large-sized graded produce meticulously sorted for consistency and high visual appeal.",
    pricePerKg: 36.00,
  ...
  },
  {
    id: 2,
    name: "AAA",
    description: "Our highest-tier, extra-large export grade, selected for exceptional size, quality, and shelf life.",
    pricePerKg: 44.00,
  ...
  },
  {
    id: 3,
    name: "BOM",
    description: "Standard Bombay-grade produce, featuring the ideal medium size highly preferred for international export.",
    pricePerKg: 111.00,
  ...
  },
  {
    id: 4,
    name: "Datra",
    description: "A compact, medium-to-small commercial grade offering excellent flavor and high value for everyday retail.",
    pricePerKg: 33.00,
  ...
  },
  {
    id: 5,
    name: "Kuli",
    description: "Small-sized graded produce, highly cost-effective and perfect for bulk processing or culinary pastes.",
    pricePerKg: 51.00,
  ...
  },
  {
    ...
    description: "Crisp, pungent, and freshly harvested onions with a robust flavor profile for everyday cooking.",
    pricePerKg: 23.00,
    image: "https://images.unsplash.com/photo-1760192499223-0dc15a4ad3c5?q=80&w=1200&auto=format&fit=crop",
  },
  {
    id: 7,
    name: "Fresh Indian Red Onion",
    description: "Authentically sourced from rich regional soils, delivering vibrant color and a distinctively sharp, traditional taste.",
    pricePerKg: 8.00,
